 ...
 */
public class LoadObrRepository
    extends CancelableFlow
    implements Flow
{

    private static final Log LOG = LogFactory.getLog( LoadObrRepository.class );

    public static final PropertyName REPOSITORY = propertyName( "repository" );

    private final File repository;

    public LoadObrRepository( final File repository )
    {
    ...
    {
        return "Loads an OBR repository from a (XML) file";
    }
