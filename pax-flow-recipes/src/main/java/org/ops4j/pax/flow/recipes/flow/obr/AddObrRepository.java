 ...
 */
public class AddObrRepository
    extends CancelableFlow
    implements Flow
{

    private static final Log LOG = LogFactory.getLog( AddObrRepository.class );
    ...
    @Inject
    public AddObrRepository( final RepositoryAdmin repositoryAdmin )
    {
        // VALIDATE
        ...
        throws Exception
    {
        ...
        LOG.info( format( "Added obr repository [%s]", url.toExternalForm() ) );
    }
