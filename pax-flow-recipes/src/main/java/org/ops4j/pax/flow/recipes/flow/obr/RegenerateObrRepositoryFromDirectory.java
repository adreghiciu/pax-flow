 ...
 */
public class RegenerateObrRepositoryFromDirectory
    extends SequentialFlow
    implements Flow
{

    public RegenerateObrRepositoryFromDirectory( final FlowName flowName,
                                                 ...
                                                 final File repositoryFile )
    {
        super(
            ...
            new ConditionalFlow(
                not( collectionIsEmpty( ListDirectory.FILES ) ),
                new SequentialFlow(
                    new CreateObrRepository( repositoryFile == null ? new File( directory, "obr.xml" ) : repositoryFile ),
                    new ForEachFlow(
                        ListDirectory.FILES, AddObrResource.BUNDLE,
                        new AddObrResource()
                    ),
        ...
        implements FlowFactory
    {
        ...
        public static final FlowType TYPE = flowType( RegenerateObrRepositoryFromDirectory.class );
        ...
        public RegenerateObrRepositoryFromDirectory create( final Configuration configuration )
        {
            final TypedConfiguration cfg = typedConfiguration( configuration );

            return new RegenerateObrRepositoryFromDirectory(
