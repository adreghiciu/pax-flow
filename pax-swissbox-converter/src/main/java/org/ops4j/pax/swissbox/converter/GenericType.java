    ...
    extends ReifiedType
{
    ...
    private final GenericType[] m_parameters;
    ...
    public String toString()
    {
        ...
        if( clazz.isArray() )
        {
            if( m_parameters.length > 0 )
            {
                return m_parameters[ 0 ].toString() + "[]";
            }
            else
            {
        ...
        if( m_parameters.length > 0 )
        {
            ...
            for( int i = 0; i < m_parameters.length; i++ )
            {
                ...
                sb.append( m_parameters[ i ].toString() );
            }
            sb.append( ">" );
            return sb.toString();
        }
    ...
    public boolean equals( final Object object )
    {
        ...
        {
            return ( other.m_parameters == null );
        }
        else
        {
            ...
            if( m_parameters.length != other.m_parameters.length )
            {
                return false;
            }
            for( int i = 0; i < m_parameters.length; i++ )
